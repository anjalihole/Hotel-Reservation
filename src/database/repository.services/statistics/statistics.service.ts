...
import { ParticipantModel } from '../../../database/models/enrollment/participant.model';
import { ErrorHandler } from '../../../common/error.handler';

import { ParticipantActivityResponseModel } from '../../../database/models/participant.responses/participant.activity.response.model';
...
const userEngagement = (enrollmentTasks, ParticipantActivityResponse) => {
    try {
        ...
        while (d < maxDate) {
            ...
            var itemsForDay = ParticipantActivityResponse.filter(
                (x) => x.TimeResponded >= dStart && x.TimeResponded < dEnd
            );
